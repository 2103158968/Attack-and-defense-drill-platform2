<template>
    <div class='sys-body'>
        <div class="sys-title">通知公告列表</div>
        <div class="sys-divider"></div>
        <div class="top-container flex-wrap box-pack-justify">
            <div class="flex-wrap">

                <div class="sys-add-btn sys-btn" @click=""><i class="el-icon-add"></i>添加通知公告</div>
        ...
        <div class="list-container">
            <el-table :data="tableData" style="width: 100%" @selection-change="handleSelectionChange"
                ...
                <el-table-column prop="name" label="通知公告名称">
                ...
                tableData: [
                    {
                        id: '1',
                        name: '里程名称',
                        createDate: '2024-05-20 11:09:00',
